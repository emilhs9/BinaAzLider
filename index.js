const home = [
  ...
  },
  {
    ...
    seher: "Sumqayıt",
    sekil:
      "https://images.unsplash.com/photo-1560185007-cde436f6a4d0?w=400&h=250&fit=crop",
  },
  {
    id: 9,
    type: "Bağ evi",
  ...
  },
  {
    ...
    seher: "Lənkəran",
    sekil:
      "https://images.unsplash.com/photo-1567767292278-a4f21aa2d36e?w=400&h=250&fit=crop",
  },
  {
    id: 14,
    type: "Yeni tikili",
  ...
  },
  {
    ...
    seher: "Şirvan",
    sekil:
      "https://images.unsplash.com/photo-1449844908441-8829872d2607?w=400&h=250&fit=crop",
  },
  {
    id: 16,
    type: "Yeni tikili",
  ...
  },
  {
    ...
    seher: "Xətai",
    sekil:
      "https://images.unsplash.com/photo-1522156373667-4c7234bbd804?w=400&h=250&fit=crop",
  },
  {
    id: 20,
    type: "Köhnə tikili",
...
function renderCards(data) {
  ...
  container.innerHTML = data
    .map(
      (item) => `
    <div onclick="window.location.href = 'detail.html?id=${item.id}'" class="bg-white rounded-xl shadow-sm hover:shadow-md transition overflow-hidden cursor-pointer border border-gray-100">
      <div class="relative">
      ...
      <div class="p-4">
        <p class="text-emerald-600 font-bold text-xl">${item.qiymet.toLocaleString()} ₼</p>
